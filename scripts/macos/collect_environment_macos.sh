...
# ============================================
# Script de Coleta: Ambiente - macOS
# ============================================
...
REPORT_FILE="$OUTPUT_DIR/environment_macos.json"
...
echo "      \"os_version\": \"$(sw_vers -productVersion)\"," >> "$REPORT_FILE"
echo "      \"os_build\": \"$(sw_vers -buildVersion)\"," >> "$REPORT_FILE"
